...
public class WheelView extends View {
	...
	boolean onReleaseMoveToEnabled = true;

	// ohad additions for lumus
	int onReleaseMoveTo = currentItem;

	public int getOnReleaseMoveTo() {
		return onReleaseMoveTo;
	}

	public void setOnReleaseMoveTo(int value) {
		onReleaseMoveTo = value;
	}

	public void enableOnReleaseMoveTo(boolean value) {
		onReleaseMoveToEnabled = value;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			if (onReleaseMoveToEnabled) {
				this.setCurrentItem(onReleaseMoveTo); // OhadOhad
			}
			if (!isScrollingPerformed) {
